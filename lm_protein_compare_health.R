...
df <- read.csv("pathway/protein.csv",na.strings = "NaN")
df_cov_time <- read.csv("pathway/tgap_table.csv",na.strings = "NaN")
...
#
write.csv(results, "pathway/lm_ref_health_protein.csv", row.names = FALSE)
